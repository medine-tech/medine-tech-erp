        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-800 p-6 rounded-lg shadow-lg border border-slate-700 hover:border-sky-800/50 transition-all duration-300">
              ...
              <p className="text-slate-300">
                Administra todos los aspectos de tu negocio desde una única plataforma intuitiva y
                potente.
              </p>
            </div>
            ...
            <div className="bg-slate-800 p-6 rounded-lg shadow-lg border border-slate-700 hover:border-sky-800/50 transition-all duration-300">
              ...
              <p className="text-slate-300">
                Obtén información valiosa con nuestro sistema de reportes y análisis de datos en
                tiempo real.
              </p>
            </div>
            ...
            <div className="bg-slate-800 p-6 rounded-lg shadow-lg border border-slate-700 hover:border-sky-800/50 transition-all duration-300">
              <div className="text-sky-500 text-xl mb-4">
                ...
                >
                  ...
                  <path d="M15.83 15.87c-.52.51-1.2.77-1.88.77m0 0c-.67 0-1.35-.26-1.87-.77m3.75 0L15 12m-2.05 4.64-1.79-3.96C12.09 12.05 13.59 10.32 13 8"></path>
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-2">Seguridad Avanzada</h3>
              <p className="text-slate-300">
                Protege tu información empresarial con sistemas de seguridad de última generación y
            ...
            <div className="bg-slate-900/50 p-8 rounded-xl shadow-xl border border-slate-700">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 text-sky-500 shrink-0 mt-0.5"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                  ...
                  <span className="text-slate-300">
                    Interfaz fácil de usar diseñada para maximizar la productividad
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <svg
                  ...
                  <span className="text-slate-300">
                    Dashboards personalizables para visualizar KPIs importantes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <svg
                  ...
                  <span className="text-slate-300">
                    Gestión completa de recursos humanos y financieros
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-slate-900/50 p-8 rounded-xl shadow-xl border border-slate-700">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-slate-300">
                    Integración perfecta con sistemas de terceros y APIs
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <svg
                  ...
                  <span className="text-slate-300">
                    Flujos de trabajo automatizados que incrementan la eficiencia
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <svg
                  ...
                  <span className="text-slate-300">
                    Plataforma escalable que crece con tu negocio
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="flex justify-center">
            <div className="bg-slate-800 p-8 rounded-xl shadow-xl max-w-md w-full border border-slate-700">
              <div className="space-y-6 text-center">
                <p className="text-slate-300">
                  ¿Necesitas ayuda con la plataforma? Nuestro equipo de soporte está disponible para
                  asistirte.
                </p>
                <div className="flex flex-col space-y-4">
                  ...
                  <Button
                    className="bg-transparent border border-slate-600 text-white hover:bg-slate-800 w-full"
                    size="lg"
                  >
                    Ver Documentación
                  </Button>
